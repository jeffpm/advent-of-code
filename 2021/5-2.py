...
def main():
    ...
    for vent in vents:
        ...
        # diagonal vents
            ...
            daRangeX = int(vent[0][0]) - int(vent[1][0])
            daRangeY = int(vent[0][1]) - int(vent[1][1])
            if daRangeX < 0:
                stepX = 1
            else:
                stepX = -1
            ...
            if daRangeY < 0:
                ...
                stepY = -1
            # print(vent)
            # print(f"da rangeX {daRangeX}")
            # print(f"da rangeY {daRangeY}")
            # print(f"stepX {stepX}")
            # print(f"stepY {stepY}")
            for x in range(0, abs(daRangeX) + 1):
                # print(x)
                # print(f"{int(vent[0][0]) + (x * stepX)}, {int(vent[0][1]) + (x * stepY)}")
                arr[int(vent[0][0]) + (x * stepX), int(vent[0][1]) + (x * stepY)] = arr[int(vent[0][0]) + (x * stepX), int(vent[0][1]) + (x * stepY)] + 1
        # print(range)
